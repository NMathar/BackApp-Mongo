<template>
  <div class="container">
    <div>
      ...
      <b-button variant="success" @click="startCron" :disabled="cron_status === 'running'">Start</b-button>
      <b-button variant="danger" @click="stopCron" :disabled="cron_status === 'stopped'" >Stop</b-button>
      <b-alert v-if="message.length > 0" v-model="message" variant="warning" dismissible>
        {{message}}
      </b-alert>
    </div>
  </div>
